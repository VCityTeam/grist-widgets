...
2. [Nominatim Geocoder](/nominatim-geocoder) : Geocodes an address column using [Nominatim](https://nominatim.org/), writing back latitude, longitude, OSM type, OSM ID, administration level, and address rank
   - Widget URL to use in Grist: `https://vcityteam.github.io/grist-widgets/nominatim-geocoder`
